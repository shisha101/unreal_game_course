...
include(my_escape_gameSource.pri)
include(my_escape_gameHeader.pri)
include(my_escape_gameConfig.pri)
include(my_escape_gameIncludes.pri)
include(my_escape_gameDefines.pri)
...
my_escape_game-Linux-Debug.commands = $$build my_escape_game Linux Debug  -project="\"$$gameProjectFile\"" $$args
my_escape_game-Linux-DebugGame.commands = $$build my_escape_game Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
my_escape_game-Linux-Shipping.commands = $$build my_escape_game Linux Shipping  -project="\"$$gameProjectFile\"" $$args
my_escape_game-Linux-Test.commands = $$build my_escape_game Linux Test  -project="\"$$gameProjectFile\"" $$args
my_escape_game.commands = $$build my_escape_game Linux Development  -project="\"$$gameProjectFile\"" $$args

my_escape_gameEditor-Linux-Debug.commands = $$build my_escape_gameEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
my_escape_gameEditor-Linux-DebugGame.commands = $$build my_escape_gameEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
my_escape_gameEditor-Linux-Shipping.commands = $$build my_escape_gameEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
my_escape_gameEditor-Linux-Test.commands = $$build my_escape_gameEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
my_escape_gameEditor.commands = $$build my_escape_gameEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	my_escape_game-Linux-Debug \
	my_escape_game-Linux-DebugGame \
	my_escape_game-Linux-Shipping \
	my_escape_game-Linux-Test \
	my_escape_game \
	my_escape_gameEditor-Linux-Debug \
	my_escape_gameEditor-Linux-DebugGame \
	my_escape_gameEditor-Linux-Shipping \
	my_escape_gameEditor-Linux-Test \
	my_escape_gameEditor \
